  ...
  return (
    <div className='flex  max-xl:flex-col ' id='hero'>
        <div className='w-1/2 max-xl:w-full h-screen max-xl:h-[500px] px-11 max-sm:px-7 pb-6 bg-gray-100 rounded-t-md text-black'>
           ...
           <h2 className='text-5xl mt-1 max-sm:text-3xl font-bold  '>Hello! I'm Johnberry </h2>
           <TypeAnimation
      sequence={[
    ...
    />
           ...
           <a href="src\Resources\John Malachy Resume.pdf" target='_blank' className='bg-black max-sm:text-[10px] max-xl:gap-3 uppercase   max-xl:px-1 px-3 flex items-center gap-2 font-bold py-2 text-white '>Download Resume<IoDownloadOutline /></a>
