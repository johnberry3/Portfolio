  ...
  return (
    <div className='text-white' id='about'>
        ...
        <div className=' text-black font-mono'>
            ...
            <p className='text-black'>John Malachy, a passionate FullStack developer with a knack for crafting beautiful and intuitive user experiences. With a strong foundation in Nodejs, CSS, and JavaScript, I specialize in building responsive and dynamic web applications that delight users and exceed client expectations.</p>
        ...
        <div className="card-slider-container max-sm:w-[290px] max-sm:m-auto md:w-[600px]  lg:w-[1200px] m-auto  mt-5">
      <Slider {...settings} >
